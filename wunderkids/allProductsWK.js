...
*/
urls = [
  'http://www.wunderkid.co/shop-art/',
  'http://www.wunderkid.co/shop-art/page/2/',
  'http://www.wunderkid.co/shop-art/page/3/',
  'http://www.wunderkid.co/shop-art/page/4/'
]
...
.then(function(pages){
	...
	pages.forEach(function($){
	  ...
	  $('.entry-product').each(function(index, elem){
...
.then(function(pageUrls){
	...
	.then(function(responses){
		...
		responses.forEach(function(response){
		  ...
		  productPrice = $('p.price').text();
		  productDescription = $('div.woocommerce-product-details__short-description').text();
		  pageTitle = $('title').text();
		  imageUrl = $('.zoomImg').attr("src");
    ...
    fs.writeFile('outputWK.json', JSON.stringify(results, null, 4), function(err){
      console.log('done');
    })
	})
	.catch(function(err){
