...
urls = [
  'http://www.bixbee.com/backpacks/',
  'http://www.bixbee.com/backpacks/?sort=featured&page=2',
  'http://www.bixbee.com/backpacks/?sort=featured&page=3',
  'http://www.bixbee.com/backpacks/?sort=featured&page=4',
  'http://www.bixbee.com/backpacks/?sort=featured&page=5',
  'http://www.bixbee.com/lunchboxes/',
  'http://www.bixbee.com/lunchboxes/?sort=featured&page=2',
  'http://www.bixbee.com/duffles/',
  'http://www.bixbee.com/duffles/?sort=featured&page=2'
]
...
.then(function(pages){
  ...
  pages.forEach(function($){
    ...
    $('.product-item-thumbnail-image').each(function(index, elem){
      ...
      var imageUrl = $(elem).find('.sr-only').attr('src');
      var productObj = {
...
.then(function(pageUrls){
  ...
  .then(function(responses){
    ...
    responses.forEach(function(response){
      ...
      productPrice = $('.product-price-line').children().first().text();
          //$('p.price > span').text();
      productDescription = $('.panel').children().first().text();
