...
*/
urls = [
  'https://kealohathreads.com/shop-1/'
]
...
.then(function(pageUrls){
	...
	.then(function(responses){
		...
		responses.forEach(function(response){
		  ...
		  productName = $('.productitem-title').text();
      //$('p.price > span').text();
      productDescription = $('div.productitem-mobile-excerpt').first().text();
      productPrice = $('.sqs-money-native').text();
      pageTitle = $('title').text();
		  imageUrl = $('.productitem-image').attr("src");
