...
*/
urls = [
  'https://kathmanduyogi.com/product-category/meditation-cushions/',
  'https://kathmanduyogi.com/product-category/yoga-bags/',
]
...
.then(function(pages){
    ...
    $('div.image-fade_in_back').each(function(index, elem){
