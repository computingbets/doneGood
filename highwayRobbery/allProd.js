...
*/
urls = [
  'http://highway-robery.com/robes/',
  'http://highway-robery.com/mini/'
]
...
.then(function(pageUrls){
	...
	.then(function(responses){
      ...
      keywords = $('.ProductDescriptionContainer.prodAccordionContent').children().first().text().split("\n");
